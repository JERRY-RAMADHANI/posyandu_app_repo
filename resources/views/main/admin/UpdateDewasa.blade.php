...
<div class="min-h-screen p-6" style="background: linear-gradient(135deg, #FF9B00 0%, #FFE100 100%);">
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-center" style="color: #FF9B00">Update Data Dewasa/Lansia</h2>
        </div>

        <form action="{{ route('daftar.dewasa.update', $dataDewasa->id) }}" method="POST" class="space-y-6" id="updateForm">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" value="{{ $dataDewasa->no_reg }}" readonly 
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ $dataDewasa->nama }}" oninput="this.value = this.value.toUpperCase()"
            ...
            <div>
                ...
                <input type="text" name="nik" value="{{ $dataDewasa->nik }}" oninput="this.value = this.value.toUpperCase()"
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>
            ...
            <div>
                ...
                <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ $dataDewasa->tanggal_lahir }}"
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            ...
            <div>
                ...
                <input type="number" name="umur" id="umur" value="{{ $dataDewasa->umur }}" readonly
            ...
            <div>
                ...
                <select name="jenis_kelamin"
                    ...
                    <option value="Laki-laki" {{ $dataDewasa->jenis_kelamin == 'LAKI-LAKI' ? 'selected' : '' }}>LAKI-LAKI</option>
                    <option value="Perempuan" {{ $dataDewasa->jenis_kelamin == 'PEREMPUAN' ? 'selected' : '' }}>PEREMPUAN</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="status"
                    ...
                    <option value="Nikah" {{ $dataDewasa->status == 'NIKAH' ? 'selected' : '' }}>NIKAH</option>
                    <option value="Belum Nikah" {{ $dataDewasa->status == 'BELUM NIKAH' ? 'selected' : '' }}>BELUM NIKAH</option>
                    <option value="Cerai Hidup" {{ $dataDewasa->status == 'CERAI HIDUP' ? 'selected' : '' }}>CERAI HIDUP</option>
                    <option value="Cerai Mati" {{ $dataDewasa->status == 'CERAI MATI' ? 'selected' : '' }}>CERAI MATI</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" name="alamat" value="{{ $dataDewasa->alamat }}" oninput="this.value = this.value.toUpperCase()"
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="rt" maxlength="3" value="{{ $dataDewasa->rt }}" oninput="this.value = this.value.toUpperCase()"
                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900">RW</label>
                    <input type="text" name="rw" maxlength="3" value="{{ $dataDewasa->rw }}" oninput="this.value = this.value.toUpperCase()"
                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
            </div>
