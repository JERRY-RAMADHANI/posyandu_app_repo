...
<head>
    ...
    {{-- Title dinamis dari section --}}
    {{-- <title>@yield('title', 'Kelurahan Krembangan Utara')</title>

    <meta name="description" content="@yield('description', 'Website resmi Kelurahan Krembangan Utara Surabaya')">

    <meta name="keywords" content="Kelurahan Krembangan Utara, Surabaya, Kecamatan Pabean Cantikan, Informasi Warga">


    <link rel="icon" href="{{ asset('storage/images/logo kkn-06.png') }}" type="image/x-icon" sizes="32x32" />
    <link rel="shortcut icon" href="{{ asset('storage/images/logo kkn-06.png') }}" type="image/x-icon" sizes="32x32" /> --}}
    ...
    <aside id="logo-sidebar"
        ...
        {{ request()->routeIs('edit.absen.dewasa') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-[#EBE389]' }}">
            ...
            {{ request()->routeIs('edit.absen.dewasa') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                 ...
                 <li>
                    <a href="{{ route('absen.balita') }}"
                        class="flex items-center p-2 rounded-lg group 
                        {{ request()->routeIs('absen.balita') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('absen.balita') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                            <path
                                d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />
                        </svg>
                        <span class="ms-3">Absen Balita</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('edit.absen.balita') }}"
                        class="flex items-center p-2 rounded-lg group 
        {{ request()->routeIs('edit.absen.balita') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-[#EBE389]' }}">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 
            {{ request()->routeIs('edit.absen.balita') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 18">
                            <path
                                d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z" />
                        </svg>
                        <span class="ms-3">Edit Absen Balita</span>
                    </a>
                </li>
        ...
        {{ request()->routeIs('edit.dewasa') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-[#EBE389]' }}">
            ...
            {{ request()->routeIs('edit.dewasa') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                ...
                <li>
                    <a href="{{ route('daftar.balita') }}"
                        class="flex items-center p-2 rounded-lg group 
        {{ request()->routeIs('daftar.balita') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-[#EBE389]' }}">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 
            {{ request()->routeIs('daftar.balita') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 18">
                            <path
                                d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z" />
                        </svg>
                        <span class="ms-3">Daftar Balita</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('edit.balita') }}"
                        class="flex items-center p-2 rounded-lg group 
        {{ request()->routeIs('edit.balita') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-[#EBE389]' }}">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 
            {{ request()->routeIs('edit.balita') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 18">
                            <path
                                d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z" />
                        </svg>
                        <span class="ms-3">Edit Data Balita</span>
                    </a>
                </li>
            ...
            {{ request()->routeIs('CekAbsen') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                ...
                <li>
                    <a href="{{ route('CetakLaporan') }}"
                        class="flex items-center p-2 rounded-lg group 
        {{ request()->routeIs('CetakLaporan') ? 'bg-gradient-to-r from-[#FF9B00] to-[#FFE100] text-white' : 'text-gray-900 hover:bg-[#EBE389]' }}">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 
            {{ request()->routeIs('CetakLaporan') ? 'text-white' : 'text-gray-500 group-hover:text-gray-900' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
                            <path
                                d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />
