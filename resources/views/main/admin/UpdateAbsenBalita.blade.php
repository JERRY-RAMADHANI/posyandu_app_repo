            ...
            <form action="{{ route('absen.balita.update', $absenBalita->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="no_reg" value="{{ $absenBalita->no_reg }}" readonly
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.1" name="usia" id="usia" value="{{ $absenBalita->usia }}" readonly
                            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.1" name="bb" value="{{ $absenBalita->bb }}"
                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Tinggi Badan (cm)</label>
                        <input type="number" step="0.1" name="tb" value="{{ $absenBalita->tb }}"
                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Lingkar Kepala (cm)</label>
                        <input type="number" step="0.1" name="lk" value="{{ $absenBalita->lk }}"
                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.1" name="ll" value="{{ $absenBalita->ll }}"
                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5">
                    </div>
