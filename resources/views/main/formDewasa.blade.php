                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 search-row">
                            ...
                            <td class="py-4 px-6">
                                @php
                                    $kosong = [];
                                    if(is_null($absen->bb)) $kosong[] = 'BB';
                                    if(is_null($absen->tb)) $kosong[] = 'TB';
                                    if(is_null($absen->lp)) $kosong[] = 'LP';
                                    if(is_null($absen->lila)) $kosong[] = 'LILA';
                                    if(is_null($absen->sistole)) $kosong[] = 'Sistole';
                                    if(is_null($absen->diastole)) $kosong[] = 'Diastole';
                                @endphp
                        ...
                        <tr class="bg-white border-b">
                            <td colspan="4" class="py-4 px-6 text-center">Tidak ada data pengukuran yang kosong</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="mt-3">
                ...
                <form id="measurementForm" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="lp" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">LILA (cm)</label>
                        <input type="number" name="lila" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Sistole</label>
                        <input type="number" name="sistole" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700">Diastole</label>
                        <input type="number" name="diastole" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    </div>
